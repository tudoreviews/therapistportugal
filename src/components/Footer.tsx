      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-t border-border pt-10 text-center space-y-4">
          ...
          <p className="text-xs text-muted-foreground font-medium uppercase tracking-widest px-4">
            © 2026 Unconventional Therapist. Todos os direitos reservados. | Criado por <a href="https://webis.pt/" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-primary transition-colors normal-case">Webis</a>
          </p>
        </div>
      </div>
    </footer>
