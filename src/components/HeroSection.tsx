    ...
    >
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center px-6 py-20 md:px-12 lg:px-24 z-10 text-center md:text-left pt-32 md:pt-0">
        <div className="max-w-2xl">
          ...
          <p className="text-white/90 text-lg md:text-xl max-w-xl mb-10 leading-relaxed mx-auto md:mx-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <Button 
              size="lg" 
              className="text-lg px-8 h-14 rounded-md bg-[#B4D600] hover:bg-[#B4D600]/90 text-black font-bold transition-all shadow-[0_0_20px_rgba(180,214,0,0.3)] hover:shadow-[0_0_30px_rgba(180,214,0,0.5)]" 
              asChild
            >
      ...
      {/* Right Content (Image) */}
      <div className="w-full md:w-1/2 flex items-center justify-center md:justify-end h-[400px] md:h-screen relative overflow-hidden">
        <img
          src={heroBanner}
          alt="Terapeutas"
