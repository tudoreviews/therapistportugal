  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-md border-b border-border transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 h-16 md:h-20 flex items-center justify-between">
        ...
        >
          <img src={logo} alt="Unconventional Therapist" className="h-6 sm:h-10 md:h-14 w-auto object-contain" />
        </Link>
      ...
      {/* Mobile Menu */}
      <div className={cn(
        "fixed inset-0 top-[65px] bg-background/98 backdrop-blur-xl z-40 md:hidden transition-all duration-300 ease-in-out origin-top",
